 ...
 * @LastEditors: DXY
 * @LastEditTime: 2022-09-26 14:42:21
-->
<template>
  <div class="container">
...
interface emitType {
  (e: "confim", value: multiAttr): void;
  (e: "update:model-value", data: any): void;
}
const emit = defineEmits<emitType>();
const handleConfirm = () => {
  emit("confim", multiAttrInfo);
};

//删除操作---动态改变需要操作父组件传递数据，深拷贝数据防止报错
const depData = ref<Array<ItemType>>([]);
...
watch(depData, (newVal) => emit("update:model-value", newVal), {
  deep: true,
  immediate: true,
});
